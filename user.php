...
<div class="container-fluid py-5">
    ...
    <p class="col-md- mb-4 fs-2 text-center" style="font-family:courier">Terima kasih telah bergabung. Silahkan segera daftar beasiswa untuk memulai perjalanan Anda.</p>
    <a href="daftar.php" class="btn btn-info btn-lg fw-bold text-white"><i class="bi bi-person-arms-up"></i> AYO DAFTAR</a>
</div>
</div>
<!--End Jumbotron-->
